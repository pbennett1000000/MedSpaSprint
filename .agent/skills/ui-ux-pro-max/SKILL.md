---
name: ui-ux-pro-max
description: UI/UX design intelligence. 67 styles, 96 palettes, 57 font pairings, 99 UX guidelines, 25 chart types, 100 reasoning rules. Auto-activates for all UI/UX design requests.
---
...
**Auto-activate** when user requests UI/UX work: design, build, create, implement, review, fix, improve any UI.
...
**User request:** "Build a landing page for a med spa wellness service"

### Step 1: Analyze Requirements
- Product type: Beauty/Spa service
- Style keywords: elegant, professional, soft, luxury
- Industry: Beauty/Wellness/Medical
- Stack: html-tailwind (default)

### Step 2: Generate Design System (REQUIRED)
```bash
python3 .agent/skills/ui-ux-pro-max/scripts/search.py "med spa beauty wellness medical luxury" --design-system -p "MedSpa"
```
